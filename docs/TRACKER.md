...
| FDD-INT-01 | docs/FDD.md | Decisão | `publishWebhookEvent` deve ser chamada dentro do `$transaction` de `changeStatus`, após `orderStatusHistory.create` | TRANSCRICAO; CODIGO | [09:40]-[09:41] Bruno, Diego; src/modules/orders/order.service.ts |
